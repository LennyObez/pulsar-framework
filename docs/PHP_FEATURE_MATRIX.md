...
| Match expression                                   | Yes     | `src/Http/Method.php`, `src/Http/ResponseStatus.php`, `src/Config/EnvironmentMode.php`, `src/Config/AppConfig.php`, `src/Observability/Log/LogLevel.php`, `src/Database/Driver.php`, `src/Database/PdoConnection.php`, `src/Database/Statement.php`, `src/Database/Transaction.php`, `src/Database/Migration/MigrationRunner.php`                                                                                                                                                                                                                                                 | Cleaner exhaustive enum matching                                |
| Nullsafe operator (`?->`)                          | Planned | -                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Null handling                                                   |
| `str_contains`, `str_starts_with`, `str_ends_with` | Yes     | `src/Http/HeaderBag.php`, `src/Routing/Route.php`, `src/Config/Environment.php`, `src/Http/Request.php`                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Native string operations                                        |
...
| Feature               | Used    | Location(s)                                                                                                                                                                                                         | Rationale                                         |
| --------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| Enums                 | Yes     | `src/Container/BindingType.php`, `src/Http/Method.php`, `src/Http/ResponseStatus.php`, `src/Config/EnvironmentMode.php`, `src/Observability/Log/LogLevel.php`, `src/Database/Driver.php`, `src/Database/FetchMode.php`, `src/Database/Migration/MigrationDirection.php` | Type-safe constants with methods                  |
...
| Feature                                     | Used    | Location(s)                                                                                                                                                                                                                                                                                                                                                                                                                                    | Rationale                                                        |
| ------------------------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| Readonly classes                            | Yes     | `src/Http/HeaderBag.php`, `src/Http/Request.php`, `src/Http/Response.php`, `src/Routing/Route.php`, `src/Routing/MatchedRoute.php`, `src/Http/RateLimit/RateLimitResult.php`, `src/Config/AppConfig.php`, `src/Config/ObservabilityConfig.php`, `src/Config/LoggingChannelConfig.php`, `src/Observability/Log/LogEntry.php`, `src/Http/Validation/Violation.php`, `src/Http/Validation/ValidationResult.php`, `src/Http/Validation/Rule/*.php`, `src/Database/Row.php`, `src/Database/Result.php`, `src/Config/DatabaseConfig.php`, `src/Config/ConnectionConfig.php`, `src/Database/Migration/MigrationFile.php`, `src/Database/Migration/MigrationRecord.php` | Fully immutable value objects, config DTOs, and validation rules |
...
| `new` in initializers     | Yes     | `src/Http/Response.php`, `src/Http/Validation/Rule/*.php` | Default HeaderBag in constructor, default empty message in rule constructors |
