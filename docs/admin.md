...
The admin panel writes audit entries for all operations through Pulsar's `AuditLogger`. These entries participate in the framework's tamper-evident audit chain (keyed BLAKE2b).
