...
| HMAC / message authentication | keyed BLAKE2b via `HmacInterface`                                | Y    | Y          | Y    | Y    | Y     | Y   | Y        | Y         | Y     | Y         |
| Password hashing              | Argon2id (PHP native `password_hash`) [^1]                       | Y    | Y          | Y    | Y    | Y     | Y   | Y        | Y         | Y     | Y         |
...
| CSRF protection                | `CsrfMiddleware` with synchronizer token pattern                   | Y    | Y          | Y    | Y    | Y     | Y   | Y        | Y         | Y     | Y         |
...
| Requirement Area        | Pulsar Capability                                              | PSD2 | PCI DSS v4 | NIS2 | GDPR | eIDAS | MDR | HL7/FHIR | ISO 13485 | SOC 2 | ISO 27001 |
| ----------------------- | -------------------------------------------------------------- | ---- | ---------- | ---- | ---- | ----- | --- | -------- | --------- | ----- | --------- |
| Immutable audit trail   | `AuditEntry` with keyed BLAKE2b chain integrity (ADR-0008)     | Y    | Y          | Y    | Y    | Y     | Y   | Y        | Y         | Y     | Y         |
