...
> **Note**: This document is superseded by [`cli-reference.md`](cli-reference.md), which contains the complete and consolidated CLI reference including all `make:*` and `remove:*` commands. This file is retained for historical reference.
