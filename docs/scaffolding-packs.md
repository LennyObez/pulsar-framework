...
Scaffolding packs are domain-specific starter kits for regulated industries. They provide entity scaffolds, configuration stubs, test templates, and scaffolding coverage documentation for common domain patterns.

> **Important**: Scaffolding packs are **scaffolds**, not certifications. They provide a starting point that supports controls for specific regulatory frameworks. They do **not** ensure, guarantee, or certify compliance with any regulation. See [Compliance disclaimer](#compliance-disclaimer) below.
...
### Create a project with a scaffolding pack

```bash
pulsar new my-banking-app --pack=banking
```

This runs the standard project scaffolding and then installs the banking scaffolding pack on top. The pack adds domain-specific entities, configuration, tests, and compliance documentation.

### Combine with presets

Scaffolding packs work alongside project presets:
...
Each scaffolding pack follows a standard directory structure:
...
Each pack includes a scaffolding coverage report that maps regulatory requirements to pack features. All entries are marked as **Scaffold** to indicate they are starting points, not production-ready implementations.
...
Every SCAFFOLDING.md includes an **Additional Steps Needed** section listing what is required for actual regulatory compliance.
...
To create a custom scaffolding pack:
...
6. Write `SCAFFOLDING.md` using "supports controls for" language. Never claim compliance or certification.
...
Scaffolding packs provide **scaffolding that supports controls for** specific regulatory frameworks. They do **not**:
...
The framework authors accept no liability for regulatory non-compliance arising from the use of scaffolding packs. See each pack's `NOT-CERTIFIED.md` for specific disclaimers.
