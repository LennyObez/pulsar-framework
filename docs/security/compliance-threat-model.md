...
- The audit chain uses keyed BLAKE2b. Each entry's hash incorporates the previous entry's hash. Modifying a single entry invalidates the hash chain from that point forward.
