...
final readonly class ThemeManager implements ThemeManagerInterface
{
    ...
    public function activate(string $themeId, string $activatedBy): InstalledTheme
    {
        ...
        if ($currentActive !== null) {
            $deactivated = new InstalledTheme(
                id: $currentActive->id,
                tenantId: $currentActive->tenantId,
                slug: $currentActive->slug,
                displayName: $currentActive->displayName,
                version: $currentActive->version,
                description: $currentActive->description,
                authorName: $currentActive->authorName,
                authorUrl: $currentActive->authorUrl,
                license: $currentActive->license,
                manifestHash: $currentActive->manifestHash,
                packageHash: $currentActive->packageHash,
                provenanceVerified: $currentActive->provenanceVerified,
                signatureVerified: $currentActive->signatureVerified,
                isActive: false,
                storagePath: $currentActive->storagePath,
                installedAt: $currentActive->installedAt,
                installedBy: $currentActive->installedBy,
                activatedAt: $currentActive->activatedAt,
                activatedBy: $currentActive->activatedBy,
                deactivatedAt: new DateTimeImmutable(),
                deletedAt: $currentActive->deletedAt,
            );
        ...
        $activated = new InstalledTheme(
            ...
            manifestHash: $theme->manifestHash,
            packageHash: $theme->packageHash,
            provenanceVerified: $theme->provenanceVerified,
            signatureVerified: $theme->signatureVerified,
            isActive: true,
            storagePath: $theme->storagePath,
            installedAt: $theme->installedAt,
            installedBy: $theme->installedBy,
            activatedAt: $now,
    ...
    private function deployAssets(InstalledTheme $theme): void
    {
        ...
        $targetDir = 'public/cms-assets/' . $theme->slug;
