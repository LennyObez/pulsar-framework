...
final readonly class ToolsService implements ToolsServiceInterface
{
    ...
    public function exportUserData(string $userId): array
    {
        ...
        $data['content'] = $contentResult->all();
        ...
        $data['translations'] = $translationResult->all();
        ...
        $data['comments'] = $commentResult->all();
        ...
        $data['settings_changes'] = $settingsResult->all();
