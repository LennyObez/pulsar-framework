...
return new class implements MigrationInterface {
    public function up(ConnectionInterface $connection): void
    {
        ...
        $connection->execute(<<<'SQL'
            CREATE TABLE cms_taxonomy_translations (
        ...
        $connection->execute(<<<'SQL'
            CREATE TABLE cms_taxonomy_term_translations (
        ...
        $connection->execute(<<<'SQL'
            CREATE UNIQUE INDEX uq_term_slug_taxonomy_locale_tenant
                ON cms_taxonomy_term_translations (taxonomy_id, locale, slug, tenant_key)
            SQL);

        $connection->execute(<<<'SQL'
            CREATE TABLE cms_content_taxonomy_terms (
