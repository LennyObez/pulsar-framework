...
return new class implements MigrationInterface {
    public function up(ConnectionInterface $connection): void
    {
        ...
        $connection->execute(<<<'SQL'
            CREATE UNIQUE INDEX uq_order_tenant_number
        ...
        $connection->execute(<<<'SQL'
            CREATE INDEX idx_order_status_tenant ON cms_orders (status, tenant_id)
            SQL);
        ...
        $connection->execute(<<<'SQL'
            CREATE INDEX idx_order_item_order ON cms_order_items (order_id)
            SQL);
        ...
        $connection->execute(<<<'SQL'
            CREATE UNIQUE INDEX uq_invoice_tenant_number
                ON cms_invoices (tenant_key, invoice_number)
            SQL);

        $connection->execute(<<<'SQL'
            CREATE INDEX idx_invoice_order ON cms_invoices (order_id)
            SQL);
    }
