...
namespace Pulsar\Extension\Observability\Internal\Exception;

use Pulsar\Api\Internal;
use RuntimeException;

/**
 * Exception thrown by the observability extension for export and configuration errors.
 */
#[Internal(reason: 'Internal exception for observability export failures')]
final class ObservabilityException extends RuntimeException
{
    ...
    {
        return new self("Invalid observability configuration: $message");
    }
}
