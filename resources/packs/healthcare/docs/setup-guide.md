...
The Healthcare control pack provides a starting point for healthcare applications built on Pulsar. It includes entity scaffolds, configuration stubs, and test templates for common healthcare domain objects.
