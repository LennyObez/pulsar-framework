...
@section('theme', 'light')
@section('title')@t('errors.400.title')@endsection

@section('content')
    <h1 class="error-page__heading" id="error-title" data-t="errors.400.heading">
        @t('errors.400.heading')
    </h1>
    <p class="error-page__description" data-t="errors.400.description">
        @t('errors.400.description')
    </p>
@endsection
