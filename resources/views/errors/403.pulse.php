...
@section('theme', 'light')
@section('title')@t('errors.403.title')@endsection

@section('content')
    <h1 class="error-page__heading" id="error-title" data-t="errors.403.heading">
        @t('errors.403.heading')
    </h1>
    <p class="error-page__description" data-t="errors.403.description">
