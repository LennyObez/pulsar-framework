...
@section('theme', 'light')
@section('title')@t('errors.405.title')@endsection

@section('content')
    <h1 class="error-page__heading" id="error-title" data-t="errors.405.heading">
        @t('errors.405.heading')
    </h1>
    <p class="error-page__description" data-t="errors.405.description">
        @t('errors.405.description')
    </p>
@endsection
