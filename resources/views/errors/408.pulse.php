...
@section('theme', 'light')
@section('title')@t('errors.408.title')@endsection

@section('content')
    <h1 class="error-page__heading" id="error-title" data-t="errors.408.heading">
        @t('errors.408.heading')
    </h1>
    <p class="error-page__description" data-t="errors.408.description">
        @t('errors.408.description')
    </p>
@endsection
