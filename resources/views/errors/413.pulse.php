...
@section('theme', 'light')
@section('title')@t('errors.413.title')@endsection

@section('content')
    <h1 class="error-page__heading" id="error-title" data-t="errors.413.heading">
        @t('errors.413.heading')
    </h1>
    <p class="error-page__description" data-t="errors.413.description">
        @t('errors.413.description')
    </p>
@endsection
