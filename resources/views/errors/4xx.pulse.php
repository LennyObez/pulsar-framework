...
@section('theme', 'light')
@section('title')@t('errors.4xx.title')@endsection

@section('content')
    <h1 class="error-page__heading" id="error-title" data-t="errors.4xx.heading">
        @t('errors.4xx.heading')
    </h1>
    <p class="error-page__description" data-t="errors.4xx.description">
        @t('errors.4xx.description')
    </p>
@endsection
