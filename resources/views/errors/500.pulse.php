...
@section('theme', 'dark')
@section('title')@t('errors.500.title')@endsection

@section('content')
    <h1 class="error-page__heading" id="error-title" data-t="errors.500.heading">
        @t('errors.500.heading')
    </h1>
    <p class="error-page__description" data-t="errors.500.description">
