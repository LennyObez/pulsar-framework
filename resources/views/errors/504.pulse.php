...
@section('theme', 'dark')
@section('title')@t('errors.504.title')@endsection

@section('content')
    <h1 class="error-page__heading" id="error-title" data-t="errors.504.heading">
        @t('errors.504.heading')
    </h1>
    <p class="error-page__description" data-t="errors.504.description">
        @t('errors.504.description')
    </p>
@endsection
