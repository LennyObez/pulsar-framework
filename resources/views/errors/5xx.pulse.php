...
@section('theme', 'dark')
@section('title')@t('errors.5xx.title')@endsection

@section('content')
    <h1 class="error-page__heading" id="error-title" data-t="errors.5xx.heading">
        @t('errors.5xx.heading')
    </h1>
    <p class="error-page__description" data-t="errors.5xx.description">
        @t('errors.5xx.description')
    </p>
@endsection
