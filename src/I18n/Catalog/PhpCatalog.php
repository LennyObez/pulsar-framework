...
/**
 * Catalog backend that loads PHP array files.
 *
 * Expects files at `{catalogPath}/{locale}/{domain}.php` returning arrays.
 */
#[Internal]
final class PhpCatalog implements CatalogInterface
{
    ...
    private function loadDomain(string $locale, string $domain): array
    {
        ...
        $path = $this->catalogPath . DIRECTORY_SEPARATOR . $locale . DIRECTORY_SEPARATOR . $domain . '.php';
