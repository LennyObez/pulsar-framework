...
final readonly class IdempotencyKey
{
     ...
     *
     * The returned key's `->value` is exactly 64 hexadecimal characters
     * (BLAKE2b 32-byte digest in hex). Downstream stores with a
     * column-length limit on the key field can size accordingly.
     *
