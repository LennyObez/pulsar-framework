...
final class MenuTest extends TestCase
{
    ...
    public function test_breadcrumb_generation_for_nested_content(): void
    {
        ...
        $translationRepo->method('findByContentAndLocale')->willReturnMap([
            ['home-001', 'en', new ContentTranslation(
                id: 'trans-home',
                contentId: 'home-001',
                locale: 'en',
                title: 'Home',
            ...
            ['docs-001', 'en', new ContentTranslation(
                id: 'trans-docs',
                contentId: 'docs-001',
                locale: 'en',
                title: 'Documentation',
            ...
            ['gs-001', 'en', new ContentTranslation(
                id: 'trans-gs',
                contentId: 'gs-001',
                locale: 'en',
