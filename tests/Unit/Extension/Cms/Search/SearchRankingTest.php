...
/**
 * Tests the composite ranking formula used by SearchService.
 *
...
{
    // -- Constants matching SearchService ----------------------------------
    ...
    #[Test]
    public function test_title_match_scores_higher_than_body_match(): void
    {
    ...
    #[Test]
    public function test_recency_boost_today_higher_than_180_days(): void
    {
    ...
    #[Test]
    public function test_recency_boost_today_equals_1_5(): void
    {
    ...
    #[Test]
    public function test_recency_boost_at_90_days(): void
    {
    ...
    #[Test]
    public function test_recency_boost_approaches_1_for_very_old_content(): void
    {
    ...
    #[Test]
    public function test_taxonomy_boost_zero_terms(): void
    {
    ...
    #[Test]
    public function test_taxonomy_boost_three_terms(): void
    {
    ...
    #[Test]
    public function test_taxonomy_boost_one_term(): void
    {
    ...
    #[Test]
    public function test_taxonomy_boost_five_terms(): void
    {
    ...
    #[Test]
    public function test_recent_content_ranks_above_stale_content_with_same_ts_rank(): void
    {
        $tsRank = 0.5;
        $taxonomyBoost = 1.0;
    ...
    #[Test]
    public function test_high_taxonomy_match_can_offset_lower_ts_rank(): void
    {
