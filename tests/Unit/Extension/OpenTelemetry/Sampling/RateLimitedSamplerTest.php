...
final class RateLimitedSamplerTest extends TestCase
{
    ...
    {
        $sampler = new RateLimitedSampler(ratePerSecond: 1000.0, maxBurst: 1.0);
        $context = $this->createContext();
        ...
        // Sleep briefly to allow refill (1ms = 1 token at 1000/s)
        // Use 20ms to account for Windows timer granularity (~15ms)
        usleep(20_000);
